      ...
      <div className="relative z-10 flex flex-col justify-between gap-4 max-h-full">
        ...
        <div className="flex-shrink-0 mt-auto">
          <input
            ...
            className="w-full max-w-lg mx-auto block p-1 md:p-4 text-lg md:text-2xl text-center font-mono bg-zinc-900/50 border-2 border-ghost/30 rounded-lg focus:outline-none focus:border-ghost focus:ring-2 focus:ring-ghost/20 transition-all backdrop-blur-sm tracking-wider"
            autoComplete="off"
            autoCapitalize="off"
            autoCorrect="off"
            spellCheck="false"
