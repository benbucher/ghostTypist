      ...
      <div className="relative z-10 flex flex-col justify-between gap-4 max-h-full">
        ...
        <div className="flex-shrink-0 mt-auto">
          <input
            ...
            className="w-full max-w-lg mx-auto block p-3 md:p-4 text-xl md:text-2xl text-center bg-slate-800 border-2 border-sky-500/50 rounded-lg focus:outline-none focus:border-sky-400 focus:ring-2 focus:ring-sky-400/50 transition-all"
            autoComplete="off"
            autoCapitalize="off"
            autoCorrect="off"
            spellCheck="false"
